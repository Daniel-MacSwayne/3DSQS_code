...
class Scene:
    ...
    gaussians : Union[GaussianModel, GaussianModel2]
    

    def __init__(self, args : ModelParams, gaussians : Union[GaussianModel, GaussianModel2], load_iteration=None, opt=None, shuffle=True, resolution_scales=[1.0]):
        """b
